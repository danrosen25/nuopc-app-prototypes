...
[ESMX](https://github.com/esmf-org/esmf/tree/develop/src/addon/ESMX) is used to implement a Generic IO Component.
...
- `GenIO`            - Example Generalized IO component. It uses a simple CMake based build system.
