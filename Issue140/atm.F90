...
#define NUOPC_TRACE__OFF
    ...
    call NUOPC_CompAttributeGet(model, name="pio_blocksize", value=valueString, &
      rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=__LINE__, &
      file=__FILE__)) &
    ...
    call NUOPC_CompAttributeGet(model, name="pio_blocksize", value=valueInt, &
      rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=__LINE__, &
      file=__FILE__)) &
