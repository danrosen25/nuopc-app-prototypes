...
module ATM
  ...
  subroutine Realize(model, rc)
    ...
    gridIn = ESMF_GridCreateNoPeriDimUfrm(name="ATM-Grid", &
      maxIndex=(/10, 20/), &
    ...
    ! importable field: sea_surface_salinity
    if (NUOPC_IsConnected(importState, fieldName="sss", &
    rc=rc)) then
      ...
      call ESMF_StateRemove(importState, (/"sss"/), &
  ...
  subroutine CheckImport(model, rc)
    ...
    if (.not.allCurrent) then
      !TODO: Check non sss fields only
